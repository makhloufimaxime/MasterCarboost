...
function renderElement(){
	...
	var className = decodeURI(location.search.substring(location.search.lastIndexOf("=")+1));
	var table = "<h2 class=\"sub-header\">" + className + "</h2>";
	...
	table = table + "<tbody>";
	table = table + "<tr><td>1</td><td><a href=\"student.html?teacher=LastName\"><b>TeacherFirstName</b></a></td><td><a href=\"student.html?teacher=LastName\"><b>TeacherFirstName</b></a></td></tr>";
	for (var i = 2; i <= 30; i++){
		table = table +  "<tr>";
		table = table + "<td>" + i + "</td>";
